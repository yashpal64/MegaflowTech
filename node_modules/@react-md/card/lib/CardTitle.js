 ...
 */
var CardTitle = react_1.forwardRef(function CardTitle(_a, ref) {
    ...
    return (react_1.default.createElement("h5", __assign({}, props, { ref: ref, className: classnames_1.default(block("title", { small: small }), {
