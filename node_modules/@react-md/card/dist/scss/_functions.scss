...
/// This function is used to quickly get one of the card's theme values. This is
/// really just for the `rmd-card-theme` mixin to provide some validation that a
/// correct style key is used, but might be useful in other cases.
///
/// @param {String} theme-style - One of the `$rmd-card-theme-values` map keys to get a value for.
/// @return {Color|String|Number} one of the card's theme values.
@function rmd-card-theme($theme-style) {
  @return rmd-theme-get-var-value($theme-style, $rmd-card-theme-values, card);
}

/// This function is used to get one of the card's theme variables as a CSS
/// Variable to be applied as a style attribute. By default, the CSS Variable
/// will have a fallback of the current `$rmd-card-theme-values`
///
...
///
/// @param {String} theme-style - One of the `$rmd-card-theme-values` map keys
/// to set a value for.
...
/// @return {String} one of the card's theme values as a css variable.
