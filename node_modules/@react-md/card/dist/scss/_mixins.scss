...
@mixin rmd-card-theme($property, $theme-style: $property, $fallback: null) {
  @include rmd-theme-apply-rmd-var($property, $theme-style, $rmd-card-theme-values, card);
}
...
@mixin rmd-card-theme-update-var($theme-style, $value) {
  @include rmd-theme-update-rmd-var($value, $theme-style, $rmd-card-theme-values, card);
}

/// Creates all the styles for the `Card` component only. You'll need to use
/// this within a selector.
@mixin rmd-card {
  @include rmd-theme-update-var(background, rmd-card-theme-var(background-color));
  @include rmd-theme-update-var(text-primary-on-background, rmd-card-theme-var(color));
  @include rmd-theme-update-var(text-secondary-on-background, rmd-card-theme-var(secondary-color));
...
@mixin rmd-card-title {
  ...
  &--small {
    @include rmd-typography-value(subtitle-1, line-height, font-size, letter-spacing);
  }
}
