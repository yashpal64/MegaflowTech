...
var useRipples_1 = __importDefault(require("./ripples/useRipples"));
var StatesConfig_1 = require("./StatesConfig");
var useKeyboardClickPolyfill_1 = __importDefault(require("./useKeyboardClickPolyfill"));
var usePressedStates_1 = __importDefault(require("./usePressedStates"));
/**
...
function useInteractionStates(options) {
    ...
    handlers.onKeyDown = useKeyboardClickPolyfill_1.default({
        disabled: disabled,
...
exports.default = useInteractionStates;
