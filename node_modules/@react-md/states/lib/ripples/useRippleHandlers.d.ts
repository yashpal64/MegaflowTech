 ...
 * returned instead.
 */
export default function useRippleHandlers<E extends HTMLElement>({ create, release, cancel, handlers, disabled: propDisabled, disableRipple, disableProgrammaticRipple, }: Options<E>): MergableRippleHandlers<E>;
export {};
