...
@mixin rmd-states-pressed-styles(
  ...
  @include rmd-utils-optional-css-modules('&#{$pressed-class-name}', $css-modules) {
    @content;
  }
}
...
@mixin rmd-states-ripple {
  ...
  &--animating {
    transition: transform $rmd-states-ripple-transform-duration $rmd-transition-deceleration,
