...
var block = utils_1.bem("rmd-avatar");
/**
...
var Avatar = react_1.forwardRef(function Avatar(_a, ref) {
    ...
    return (react_1.default.createElement("span", __assign({}, props, { ref: ref, className: classnames_1.default(block((_b = {}, _b[color] = color, _b)), className) }),
        img,
        children));
});
