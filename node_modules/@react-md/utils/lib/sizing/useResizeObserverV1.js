...
exports.warnedOnce = exports.isWidthChange = exports.isHeightChange = exports.getResizeObserverTarget = void 0;
...
function useResizeObserverV1(_a) {
    ...
    if (process.env.NODE_ENV !== "production") {
        ...
        if (!exports.warnedOnce[key]) {
            exports.warnedOnce[key] = true;
            var message = void 0;
            if (isComp) {
...
exports.default = useResizeObserverV1;
