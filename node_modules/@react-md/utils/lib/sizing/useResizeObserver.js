...
var useResizeObserverV1_1 = __importDefault(require("./useResizeObserverV1"));
/**
 * @private
 * @internal
 */
...
function init() {
    ...
    sharedObserver = new resize_observer_polyfill_1.default(function (entries) {
...
function useResizeObserver(arg1, arg2) {
    ...
    if (typeof arg1 !== "function") {
        useResizeObserverV1_1.default(arg1);
        return;
    }
    var onResize = arg1;
