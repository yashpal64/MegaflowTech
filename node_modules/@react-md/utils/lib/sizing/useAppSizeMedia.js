...
exports.DEFAULT_APP_SIZE = void 0;
var react_1 = require("react");
var constants_1 = require("./constants");
var useWidthMediaQuery_1 = __importDefault(require("./useWidthMediaQuery"));
var useOrientation_1 = __importDefault(require("./useOrientation"));
...
function useAppSizeMedia(_a) {
    ...
    var isLandscape = useOrientation_1.default().includes("landscape");
    var isLargeDesktop = matchesLargeDesktop;
    var _j = react_1.useState(defaultSize), appSize = _j[0], setAppSize = _j[1];
...
exports.default = useAppSizeMedia;
