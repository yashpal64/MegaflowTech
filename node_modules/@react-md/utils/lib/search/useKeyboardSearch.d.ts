 ...
 */
export default function useKeyboardSearch<D = unknown, E extends HTMLElement = HTMLElement>({ items, onChange, onKeyDown, resetTime, searchIndex, valueKey, getItemValue, findMatchIndex, }: KeyboardSearchOptions<D, E>): ReturnValue<E>;
export {};
