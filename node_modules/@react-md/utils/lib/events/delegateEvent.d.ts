 ...
 */
export default function delegateEvent(eventType: string, eventTarget?: DelegatedEventTarget, throttle?: boolean, options?: boolean | AddEventListenerOptions): DelegatedEventHandler;
