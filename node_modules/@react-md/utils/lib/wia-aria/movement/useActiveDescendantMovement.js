...
var scrollIntoView_1 = __importDefault(require("../../scrollIntoView"));
var useKeyboardMovement_1 = __importDefault(require("./useKeyboardMovement"));
var utils_1 = require("./utils");
var utils_2 = require("../../search/utils");
/**
...
function useActiveDescendantMovement(_a) {
    var baseId = _a.baseId, _b = _a.getId, getId = _b === void 0 ? utils_1.getItemId : _b, _c = _a.defaultFocusedIndex, defaultFocusedIndex = _c === void 0 ? -1 : _c, items = _a.items, onChange = _a.onChange, _d = _a.getItemValue, getItemValue = _d === void 0 ? utils_2.DEFAULT_GET_ITEM_VALUE : _d, _e = _a.valueKey, valueKey = _e === void 0 ? utils_2.DEFAULT_VALUE_KEY : _e, onKeyDown = _a.onKeyDown, onEnter = _a.onEnter, onSpace = _a.onSpace, options = __rest(_a, ["baseId", "getId", "defaultFocusedIndex", "items", "onChange", "getItemValue", "valueKey", "onKeyDown", "onEnter", "onSpace"]);
    ...
    var _g = useKeyboardMovement_1.default(__assign(__assign({}, options), { valueKey: valueKey,
        ...
        onChange: function (data, itemRefs) {
            ...
            if (item && target && target.scrollHeight > target.offsetHeight) {
                scrollIntoView_1.default(target, item);
            }
...
exports.default = useActiveDescendantMovement;
