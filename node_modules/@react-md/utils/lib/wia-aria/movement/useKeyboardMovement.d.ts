 ...
 * that can be focusable.
 */
export default function useKeyboardMovement<D = unknown, CE extends HTMLElement = HTMLElement, IE extends HTMLElement = HTMLElement>({ onKeyDown, incrementKeys, decrementKeys, jumpToFirstKeys, jumpToLastKeys, stopPropagation, onChange, items, resetTime, findMatchIndex, focusedIndex, loopable, searchable, valueKey, getItemValue, }: KeyboardMovementOptions<D, CE, IE>): KeyboardMovementProviders<CE, IE>;
