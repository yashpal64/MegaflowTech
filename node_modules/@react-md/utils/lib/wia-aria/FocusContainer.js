...
var useFocusOnMount_1 = __importDefault(require("./useFocusOnMount"));
var usePreviousFocus_1 = __importDefault(require("./usePreviousFocus"));
var useTabFocusWrap_1 = __importDefault(require("./useTabFocusWrap"));
/**
 * The `FocusContainer` is a wrapper for a few of the accessibility hooks to
 * maintain focus within an element.
 */
var FocusContainer = react_1.forwardRef(function FocusContainer(_a, forwardedRef) {
