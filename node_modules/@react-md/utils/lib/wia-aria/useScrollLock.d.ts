 ...
 * @internal
 */
export declare function enable(element: HTMLElement): void;
/**
 ...
 * @internal
 */
export declare function disable(element: HTMLElement): void;
/**
 ...
 */
export default function useScrollLock(enabled: boolean, selectorOrElement?: string | HTMLElement | (() => HTMLElement) | null): void;
