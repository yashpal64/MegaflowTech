...
exports.GRID_GUTTER_VAR = exports.GRID_COLUMNS_VAR = void 0;
...
var block = bem_1.default("rmd-grid");
/**
 ...
 */
var Grid = react_1.forwardRef(function Grid(_a, ref) {
    var _b;
    ...
    var _f = useAppSize_1.default(), isPhone = _f.isPhone, isTablet = _f.isTablet, isDesktop = _f.isDesktop, isLargeDesktop = _f.isLargeDesktop;
    ...
    if (clone || wrapOnly) {
        content = react_1.Children.map(children, function (child) { return child && react_1.default.createElement(GridCell_1.default, { clone: clone }, child); });
    }
