...
exports.createAnchoredBelow = exports.createAnchoredBottom = exports.createAnchoredCenter = exports.createAnchoredTop = exports.createAnchoredAbove = void 0;
...
function createAnchoredBelow(config) {
    ...
    if (preventOverlap) {
        ...
        return {
            ...
            bottom: getViewportSize_1.default("height") - availableTop,
        };
    }
...
exports.default = createVerticalPosition;
