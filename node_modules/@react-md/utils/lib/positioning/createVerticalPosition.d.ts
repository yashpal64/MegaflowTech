 ...
 * @private
 */
export default function createVerticalPosition({ y, vh, vhMargin, yMargin, elHeight, initialY, containerRect, disableSwapping, preventOverlap, disableVHBounds, }: Options): YPosition;
export {};
