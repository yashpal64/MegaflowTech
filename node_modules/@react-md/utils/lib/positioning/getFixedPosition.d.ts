 ...
 */
export default function getFixedPosition({ container, element, anchor: propAnchor, initialX, initialY, vwMargin, vhMargin, xMargin, yMargin, width: widthType, preventOverlap, transformOrigin, disableSwapping, disableVHBounds, }: FixedPositionOptions): FixedPosition;
