declare type Running = boolean;
declare type StartInterval = () => void;
declare type StopInterval = () => void;
declare type ReturnValue = [Running, StartInterval, StopInterval];
/**
 ...
 */
export default function useInterval(callback: (stop: () => void) => void, delay: number, defaultRunning?: boolean): ReturnValue;
export {};
