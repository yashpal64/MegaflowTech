...
import { BaseKeyboardMovementOptions, MovementHandler, ItemRefList } from "./useKeyboardMovement";
 ...
 * that can be focusable.
 */
export default function useActiveDescendantMovement<D = unknown, CE extends HTMLElement = HTMLElement, IE extends HTMLElement = HTMLElement>({ baseId, getId, defaultFocusedIndex, items, onChange, getItemValue, valueKey, onKeyDown, onEnter, onSpace, ...options }: ActiveDescendantOptions<D, CE, IE>): ActiveDescendantMovementProviders<CE, IE>;
export {};
