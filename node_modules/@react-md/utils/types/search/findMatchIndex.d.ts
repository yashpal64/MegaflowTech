 ...
 * @private
 */
export declare function findMatchInRange(value: string, values: readonly string[], startIndex: number, endIndex: number): number;
/**
 ...
 * @private
 */
export default function findMatchIndex(value: string, values: readonly string[], startIndex: number, isSelfMatchable?: boolean): number;
export declare type FindMatchIndex = typeof findMatchIndex;
