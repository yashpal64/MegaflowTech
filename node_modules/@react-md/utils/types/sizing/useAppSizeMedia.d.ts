 ...
 * @private
 */
export default function useAppSizeMedia({ phoneMaxWidth, tabletMinWidth, tabletMaxWidth, desktopMinWidth, desktopLargeMinWidth, defaultSize, }?: AppSizeOptions): AppSize;
