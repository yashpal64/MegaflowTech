...
import { AppSize, AppSizeOptions } from "./useAppSizeMedia";
 ...
 */
declare function AppSizeListener({ children, onChange, phoneMaxWidth, tabletMinWidth, tabletMaxWidth, desktopMinWidth, desktopLargeMinWidth, defaultSize, }: AppSizeListenerProps): ReactElement;
declare namespace AppSizeListener {
    var propTypes: {
        children: any;
        onChange: any;
        phoneMaxWidth: any;
