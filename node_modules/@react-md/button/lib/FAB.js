...
var styles = utils_1.bem("rmd-fab");
/**
 ...
 */
exports.default = react_1.forwardRef(function FAB(_a, ref) {
    ...
    return (react_1.default.createElement("span", __assign({}, props, { ref: ref, className: classnames_1.default(styles({
