...
@mixin rmd-icon-spaced-with-text(
  ...
  @if $before-selector != null {
    #{$before-selector} {
      @include rmd-icon-text-spacing(rmd-icon-theme-var(text-spacing), margin-right);
    }
  }

  @if $after-selector != null {
    #{$after-selector} {
      @include rmd-icon-text-spacing(rmd-icon-theme-var(text-spacing), margin-left);
    }
  }

  @if $above-selector != null {
    #{$above-selector} {
      @include rmd-icon-text-spacing(rmd-icon-theme-var(text-spacing), margin-bottom);
    }
  }

  @if $below-selector != null {
    #{$below-selector} {
      @include rmd-icon-text-spacing(rmd-icon-theme-var(text-spacing), margin-top);
    }
  }
}
