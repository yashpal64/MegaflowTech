...
declare type ReturnValue<E extends HTMLElement> = [Rendered, CollapseTransitionProvidedProps<E>];
/**
 ...
 */
export default function useCollapse<E extends HTMLElement = HTMLDivElement>(collapsed: boolean, { className, appear, timeout, onEnter, onEntering, onEntered, onExit, onExiting, onExited, minHeight, minPaddingTop, minPaddingBottom, temporary, }?: CollapseOptions<E>): ReturnValue<E>;
export {};
