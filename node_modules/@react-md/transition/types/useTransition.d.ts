...
import { TransitionStage, TransitionAction } from "./constants";
 ...
 */
export default function useTransition<E extends HTMLElement = HTMLDivElement>({ appear, repaint, temporary, transitionIn, timeout: propTimeout, onEnter, onEntering, onEntered, onExit, onExiting, onExited, ref: propRef, }: TransitionOptions<E>): TransitionReturnValue<E>;
