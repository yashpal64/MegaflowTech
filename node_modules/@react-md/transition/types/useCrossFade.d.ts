...
import { CSSTransitionReturnValue } from "./useCSSTransition";
export interface CrossFadeOptions<E extends HTMLElement> extends Omit<CSSTransitionOptions<E>, "timeout" | "classNames" | "transitionIn"> {
 ...
 */
export default function useCrossFade<E extends HTMLElement = HTMLDivElement>({ appear, temporary, transitionIn, className, onEnter, onEntering, onEntered, onExit, onExiting, onExited, }?: CrossFadeOptions<E>): CSSTransitionReturnValue<E>;
