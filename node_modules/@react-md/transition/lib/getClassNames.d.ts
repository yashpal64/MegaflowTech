...
declare type DefinedCSSTransitionClassNames = Required<CSSTransitionClassNames>;
/**
 ...
 * @private
 */
export default function getClassNames(classNames: CSSTransitionClassNames | string, timeout: DefinedTimeout): DefinedCSSTransitionClassNames;
export {};
