...
var getNextStage_1 = __importDefault(require("./getNextStage"));
...
function useTransition(_a) {
    ...
    var timeout = getTimeout_1.default(propTimeout, appear);
    ...
    react_1.useEffect(function () {
        ...
        var duration = getTimeoutDuration_1.default(stage, timeout.appear, timeout.enter, timeout.exit, appearing);
        if (duration <= 0) {
            dispatch(nextStage);
            return;
        }
