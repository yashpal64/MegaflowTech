...
export declare type CSSTransitionReturnValue<E extends HTMLElement> = [Rendered, CSSTransitionProvidedProps<E>, Dispatch<TransitionAction>, TransitionStage];
/**
 ...
 */
export default function useCSSTransition<E extends HTMLElement = HTMLDivElement>({ appear, temporary, timeout, transitionIn, onEnter, onEntering, onEntered, onExit, onExiting, onExited, className, classNames: propClassNames, ref: propRef, }: CSSTransitionOptions<E>): CSSTransitionReturnValue<E>;
export {};
