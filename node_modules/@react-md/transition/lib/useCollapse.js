...
var getElementSizing_1 = __importDefault(require("./getElementSizing"));
var getTimeout_1 = __importDefault(require("./getTimeout"));
var useTransition_1 = __importDefault(require("./useTransition"));
/**
...
function useCollapse(collapsed, _a) {
    ...
    var _k = useTransition_1.default({
        appear: appear,
        repaint: true,
        timeout: timeout,
        temporary: temporary,
        ...
        onEntering: function (node, isAppearing) {
            ...
            var _a = getElementSizing_1.default(node), maxHeight = _a.maxHeight, paddingTop = _a.paddingTop, paddingBottom = _a.paddingBottom;
            var defaultedTimeout = getTimeout_1.default(timeout, isAppearing);
        ...
        onExit: function (node) {
            ...
            setStyle({
                ...
                paddingTop: paddingTop,
                paddingBottom: paddingBottom,
                transitionDuration: getTimeout_1.default(timeout, false).exit + "ms",
            });
        },
    ...
    var collapsable = react_1.useMemo(function () { return Object.values(getTimeout_1.default(timeout, false)).some(function (v) { return v !== 0; }); }, [timeout]);
