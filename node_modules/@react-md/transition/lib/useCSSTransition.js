...
var getClassNames_1 = __importDefault(require("./getClassNames"));
...
function useCSSTransition(_a) {
    ...
    var _d = useTransition_1.default({
        ref: propRef,
        appear: appear,
        repaint: true,
        timeout: timeout,
    ...
    var classNames = getClassNames_1.default(propClassNames, getTimeout_1.default(timeout, appear));
...
exports.default = useCSSTransition;
