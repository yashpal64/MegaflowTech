...
export interface MediaContainerWithAspectRatioProps extends MediaContainerProps {
    height: number;
    width: number;
}
/**
 ...
 * provided.
 */
declare const MediaContainer: React.ForwardRefExoticComponent<(MediaContainerProps & React.RefAttributes<HTMLDivElement>) | (MediaContainerWithAspectRatioProps & React.RefAttributes<HTMLDivElement>)>;
